...
class Brf_Pro_Forms_SubmitButton extends \Bricks\Element
{
    ...
    public function render()
    {
        ...
        if (isset($submitButtonHasCondition) && $submitButtonHasCondition && isset($parent_settings['submitButtonConditionAction']) && !empty($parent_settings['submitButtonConditionAction']) && $parent_settings['submitButtonConditionAction'] === 'disabled') {
            $this->set_attribute('submit-button', 'disabled');
        }
