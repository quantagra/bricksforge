...
class Admin
{
    ...
    public function add_plugin_links($links)
    {
        $links = array_merge(
            array(
                ...
                '<a style="color: #555; font-weight: 600" href="https://docs.bricksforge.io/" target="_blank">' . __('Documentation', 'bricksforge') . '</a>'
            ),
            $links
        );
    ...
    public function enqueue_scripts()
    {
        ...
        $args = array(
            ...
            'pages'                    => query_posts(["post_type" => ["page", "bricks_template"], 'posts_per_page' => 200]),
            'ptPage'                    => query_posts(["post_type" => "page", 'posts_per_page' => -1]),
